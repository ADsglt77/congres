...
<div class="container">
    ...
    <div class="right">
        <!-- Afficher les activités avec des cases à cocher pour le congressiste -->
                        ...
                        <tbody>
                            <?php foreach ($LesActivites as $activite) { ?>
                                <tr>
                                    ...
                                    <!-- Liste déroulante pour chaque activité -->
                                    <td>
                                        <select name="id_accompagnant_<?php echo $activite->id; ?>">
                                            <option value="">Sélectionner un accompagnant</option>
                                            <?php foreach ($LesAccompagnants as $accompagnant) { ?>
                                                <option value="<?php echo $accompagnant->id; ?>"
                                                    <?php echo isset($accompagnantSelectionne[$activite->id]) && $accompagnantSelectionne[$activite->id] == $accompagnant->id ? 'selected' : ''; ?>>
                                                    <?php echo htmlspecialchars($accompagnant->nom, ENT_QUOTES, 'UTF-8'); ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    </td>
